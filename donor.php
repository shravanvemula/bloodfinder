...
<ol>
  ...
  <li><a href="http://www.india.com/news/india/kerala-temple-asks-devotees-to-donate-blood-for-abhishek-during-celebration-of-annual-festival-2930746/">Kerala: Temple Asks Devotees to Donate Blood For 'Abhishek' During Celebration of Annual Festival</a></li>
...
<h2 class="title">You can find blood donors here of the required blood group</h2>
...
<div class ="log">
   ...
   <form action="donor1.php" method="POST">
    ...
    <h1></h1>
    <br><br>
     <label>Enter the Blood group you require:</label>
        <input type="text" name="xyz" required="" placeholder="Enter blood group">
        <br><br>
